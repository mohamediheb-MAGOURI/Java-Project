...
This academic project showcases core concepts including:
...
- **CRUD Operations**: Full Create, Read, Update, Delete functionality for cars, customers, and rentals
- **Car Management**: Add, view, update, and delete vehicles from the rental fleet with availability tracking
- **Rental Management**: Process car rentals with automatic availability status updates
- **Rental History**: View and manage all active and completed rental transactions
- **Invoicing/Facturation**: Generate detailed rental invoices with pricing and tax calculations
